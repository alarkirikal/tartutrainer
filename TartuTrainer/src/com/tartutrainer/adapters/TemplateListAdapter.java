...
public class TemplateListAdapter extends BaseAdapter {
    ...
    public TemplateListAdapter(Activity a, ArrayList<String> e) {
        activity = a;
        name=e;
    ...
    public void removeCheck(View v) {
    	CheckBox toClear = (CheckBox) v.findViewById(R.id.templateCheckbox);
    	toClear.setChecked(false);
    }
