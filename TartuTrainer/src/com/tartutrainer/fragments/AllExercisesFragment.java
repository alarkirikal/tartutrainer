...
public class AllExercisesFragment extends Fragment implements OnClickListener,
	...
	private void populateSpinners(View v) {
		...
		Spinner modalities = (Spinner) v
				.findViewById(R.id.exercisesSortModality);
		...
		ArrayAdapter<String> levelAdapter = new ArrayAdapter<String>(
				getActivity(), android.R.layout.simple_spinner_item, levelArray);
		levelAdapter
		...
		ArrayAdapter<String> equipAdapter = new ArrayAdapter<String>(
				getActivity(), android.R.layout.simple_spinner_item, equipArray);
		equipAdapter
				.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
		...
		ArrayAdapter<String> muscleAdapter = new ArrayAdapter<String>(
